...
public class International extends Faculty {

    byte instrument;

    public International(byte instrument) {
    ...
    public Pattern playMainMelody(int wholes, Key key) {
        ...
        p.traverseWithStyle(n, ps1, 2929, wholes);
    ...
    public Pattern playSecondary(int wholes, Key key) {
        ...
        // Perform the traversal
        p.traverseWithStyle(n, ps1, 5741782, wholes);
